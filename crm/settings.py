...
# DwGCDqtcqzzGO2XK87u7bVSEUqHogZRFl4UdhkcCudSHxLUVvx
...
#EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'mail.alotimnhanh.com')
#EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'crm@alotimnhanh.com')
#EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'duyman123#$')
...
#EMAIL_HOST = 'mail.alotimnhanh.com'
#EMAIL_HOST_USER = os.getenv('SG_USER', 'crm@alotimnhanh.com')
#EMAIL_HOST_PASSWORD = os.getenv('SG_PWD', 'duyman123#$')
#EMAIL_PORT = 465
#MAIL_USE_TLS = False
#MAIL_USE_SSL = True
...
#EMAIL_PORT = 465
#EMAIL_HOST = 'mail.alotimnhanh.com'
#EMAIL_HOST_USER = 'crm@alotimnhanh.com'
#EMAIL_HOST_PASSWORD = 'duyman123#$'

EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'mail.alotimnhanh.com')
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'crm@alotimnhanh.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'duyman123#$')
MAIL_SENDER = os.environ.get('MAIL_SENDER', 'Project Admin<crm@alotimnhanh.com>')
#PROJECT_ADMIN = os.environ.get('PROJECT_ADMIN', 'PROJECT_ADMIN')
MAIL_PORT = int(os.environ.get('MAIL_PORT', '465'))
MAIL_USE_TLS = int(os.environ.get('MAIL_USE_TLS',  False))
MAIL_USE_SSL = int(os.environ.get('MAIL_USE_SSL',  True)) 
...
DEFAULT_FROM_EMAIL = 'crm@alotimnhanh.com'
...
ADMIN_EMAIL = "crm@alotimnhanh.com"

URL_FOR_LINKS = "http://crm.ihomereal.com"
...
MARKETING_REPLY_EMAIL = 'info@alotimnhanh.com'
