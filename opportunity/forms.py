...
class OpportunityForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        opp_leads = kwargs.pop('leads', [])
        opp_listings = kwargs.pop('listings', [])
        ...
        self.fields['leads'].queryset = opp_leads
        self.fields['leads'].required = False
        self.fields['listings'].queryset = opp_listings
        self.fields['listings'].required = False
    ...
    class Meta:
        model = Opportunity
        fields = (
            'name', 'amount', 'account', 'contacts', 'leads', 'listings', 'assigned_to', 'currency',
            'probability', 'closed_on', 'lead_source', 'description', 'stage', 'status',
        )
